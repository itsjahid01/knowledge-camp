      ...
      <div className="card shadow-lg p-2">
        ...
        <div className="p-4">
          <div className="flex justify-between items-center">
            ...
            <div><span>{read_time} min read</span> <span className="ml-1 cursor-pointer"><FontAwesomeIcon icon={faBookmark} /></span></div>
          </div>
          <h2 className="text-2xl font-bold mt-3 mb-3">{title}</h2>
          <p>#beginners #programming</p>
          <p className="w-24 text-blue-600 underline cursor-pointer mt-3">Mark as read</p>
        </div>
      </div>
    </div>
  );
